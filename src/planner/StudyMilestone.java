...
public class StudyMilestone {
    ...
    /**
     *
     * @return DLM of study milestones
...
//        JTextArea tArea = new JTextArea();
    ...
    /**
     *
     * @param list JList containing Milestone ID
     * @return DLM containing information of that milestone
     * @throws SQLException throws exception if error in SQL 
     * @throws ClassNotFoundException throws exception if class not found
     */
...
//        JTextArea tArea = new JTextArea();
    ...
    /**
     *
     * @param milestoneID milestone ID number
     * @param milestoneName name of milestone
     * @param target the aim of the milestone
     * @param progress how much progress u have made towards it 
     * @throws SQLException throws exception if error in SQL 
     * @throws ClassNotFoundException throws exception if class not found
     */
...
//        System.out.println(sql);
     ...
     *
     * @param milestoneID milestone ID number
     * @param progress how much progress u have made toward the milestone
     * @throws SQLException throws exception if error in SQL 
     * @throws ClassNotFoundException throws exception if class not found
     */
