...
public class StudyActivity {
    ...
    /**
     *
     * @param list JList for coursework study activity Data
     * @return DML containing information about the coursework study activity
     * @throws SQLException throws exception is SQL error
...
//        JTextArea tArea = new JTextArea();
    ...
    /**
     *
     * @param list JList for exam study activity Data
     * @return DML containing information about the exam study activity
     * @throws SQLException throws exception is SQL error
     * @throws ClassNotFoundException throws exception if class cannot be found
     */
...
//            System.out.println("ID = " + id);
    ...
    /**
     *
     * @return returns DLM containing coursework study activity 
     * @throws SQLException throws exception is SQL error
     * @throws ClassNotFoundException throws exception if class cannot be found
     */
...
//        System.out.println("temp=" + temp);
    ...
    /**
     *
     * @return returns DLM containing exam study activity 
     * @throws SQLException throws exception is SQL error
     * @throws ClassNotFoundException throws exception if class cannot be found
     */
...
//        System.out.println("temp=" + temp);
    ...
    /**
     *
     * @param activityID coursework study activity ID number
     * @param activityName coursework study activity name
     * @param cwStudyID coursework study task ID
     * @param progress How much progress this is towards its Task
     * @param note A note on the activity 
     * @param timeSpent Time spent in minutes on activity 
...
//        System.out.println(sql);
    ...
    /**
     *
     * @param activityID exam study activity ID number
     * @param activityName exam study activity name
     * @param examStudyID exam study task ID
     * @param progress How much progress this is towards its Task
     * @param note A note on the activity
     * @param timeSpent Time spent in minutes on activity 
     * @throws SQLException throws exception if error in SQL 
...
//        System.out.println(sql);
    ...
    /**
     *
     * @param cw_study_act_ID ID number of coursework activity 
     * @param cw_study_act_timeSpent time in minutes
     * @param cw_study_act_progress how much progress you have made towards it
     * @throws SQLException throws exception if error in SQL 
     * @throws ClassNotFoundException throws exception if class not found
     */
    ...
    /**
     *
     * @param exam_study_actID ID number of exam activity 
     * @param exam_study_actTimeSpent time in minutes
     * @param exam_study_act_progress how much progress you have made towards it
     * @throws SQLException throws exception if error in SQL 
     * @throws ClassNotFoundException throws exception if class not found
     */
